...
if lifes <= 0 {
	...
	if sprite_index == sprPinkStarDeadGround && image_index == 1 && place_meeting(x, y + 1, objColisParede) {
		var _effect = instance_create_layer(x - 5, y + 2.5, layer, objEffects);
			_effect.direc = 2
	}
	
	// Da moedas ao player
	if (sprite_index == sprPinkStarDeadGround && image_index == 0) {
